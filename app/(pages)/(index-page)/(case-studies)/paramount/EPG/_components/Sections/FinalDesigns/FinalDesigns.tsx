...
export default function FinalDesigns(content: contentProps) {
  ...
  const videoLinks = [
    activeDesignButton === false
      ...
      : getImageUrl(content.images, 'optimized-mobile-pip.mp4'), // pip
    activeDesignButton === false
      ? getImageUrl(content.images, 'optimized-desktop-tiles.mp4')
      : getImageUrl(content.images, 'optimized-mobile-tiles.mp4'), // tiles
    activeDesignButton === false
      ? getImageUrl(content.images, 'optimized-desktop-search.mp4')
      : getImageUrl(content.images, 'optimized-mobile-search.mp4'), // search
    activeDesignButton === false
      ? getImageUrl(content.images, 'optimized-desktop-favorites.mp4')
      : getImageUrl(content.images, 'optimized-mobile-favorites.mp4'), // favorites
  ];
